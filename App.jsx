    ...
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column"}}>
      ...
      <footer className="landing-footer" style={{borderTop:`1px solid ${C.border}`,padding:"32px 56px",display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:20}}>
        ...
        <div style={{display:"flex",gap:48,flexWrap:"wrap"}}>
          {[
            {title:"Produit",links:[
              {l:"Comment ça marche",url:"https://studyreach1.vercel.app"},
              {l:"Tarifs",url:"https://studyreach1.vercel.app"},
              {l:"Pour les participants",url:"https://studyreach1.vercel.app"},
              {l:"Blog",url:"https://studyreach1.vercel.app"},
            ]},
            {title:"Légal",links:[
              {l:"CGU",url:null,nav:"terms"},
              {l:"Politique de confidentialité",url:null,nav:"privacy"},
              {l:"Mentions légales",url:null,nav:"terms"},
              {l:"RGPD",url:"https://www.cnil.fr/fr/rgpd-de-quoi-parle-t-on"},
            ]},
            {title:"Support",links:[
              {l:"Centre d'aide",url:"mailto:support@studyreach.io"},
              {l:"Contact",url:"mailto:contact@studyreach.io"},
              {l:"Status",url:"https://studyreach1.vercel.app"},
              {l:"API",url:"https://supabase.com/docs"},
            ]},
          ].map(col=>(
            <div key={col.title}>
