              ...
              {ns.mode==="ai"&&(
                <>
                  ...
                  {[
                    ...
                    return(
                      <label key={opt.key} style={{display:"flex",alignItems:"flex-start",gap:10,cursor:lockedOn?"not-allowed":"pointer",background:checked?"#a855f711":C.bg,border:`1px solid ${checked?"#a855f744":C.border}`,borderRadius:10,padding:"10px 14px",marginBottom:8,opacity:lockedOn?.75:1}}>
