...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
function AiReportModal({data,onClose,onViewProfile,onQuality}){
  const tabs=[
    ...
    (async()=>{
      ...
      try{
        ...
        if(typeof out?.quality_score==="number"){
          ...
          // Persistance via RPC sécurisée (autorise uniquement les colonnes qualité).
          try{
      ...
      <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:18,padding:"12px 16px",background:C.surfaceHigh,borderRadius:12,border:`1px solid ${C.border}`}}>
        ...
        {typeof score==="number"&&(
          <div style={{textAlign:"center",flexShrink:0}}>
            ...
            <div style={{fontSize:10,color:C.muted,marginTop:2}}>match /100</div>
          </div>
        )}
      </div>
      {qLoading&&(
