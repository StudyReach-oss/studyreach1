  ...
  const pages={
    "how-it-works":{
      ...
      sections:[
        ...
        {icon:"🤖",title:"Entretiens IA (option)",body:"Activez le mode IA pour laisser notre intelligence artificielle conduire l’entretien à votre place. Elle pose vos questions, gère les relances, et vous livre un rapport synthétique complet avec verbatims dès la fin de l'entretien."},
    ...
    "faq":{
      ...
      sections:[
        ...
        {icon:"🤖",title:"Comment fonctionne le mode IA ?",body:"En activant le mode IA (+10€ par participant), notre intelligence artificielle conduit l'entretien à votre place selon votre guide de questions. Elle gère les relances et vous livre un rapport complet avec verbatims dès la fin de chaque entretien."},
