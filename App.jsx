...
function OnboardingModal({role,onClose,onStart}){
  ...
  const steps=isPart?[
    ...
    {icon:"💸",title:"Soyez payé",body:"Le montant affiché pour chaque étude est exactement ce que vous touchez. Une fois la participation validée, il est crédité sur votre solde ; vous pouvez le retirer dès 5€ de gains, et il arrive sur votre compte bancaire sous 24-72h après le retrait."},
  ]:[
