...
const INIT_P_STUDIES=[
  {id:1,title:"Test UX application mobile",researcher:"Sophie R.",company:"DesignLab",dur:"20 min",mode:"Lien",pay:27,deadline:"08 juin 2026",theme:"🎨 UX",status:"available",desc:"Nous testons une nouvelle application mobile de gestion de tâches. Vous naviguerez dans des maquettes interactives et donnerez votre avis."},
  {id:2,title:"Habitudes alimentaires 2026",researcher:"Lucas P.",company:"FoodInsights",dur:"45 min",mode:"IA",pay:36,deadline:"12 juin 2026",theme:"🛒 Conso",status:"available",desc:"Une étude sur vos habitudes alimentaires quotidiennes. Entretien mené par IA, réponses libres."},
  {id:3,title:"Satisfaction service bancaire",researcher:"Amira K.",company:"BNP Paribas",dur:"10 min",mode:"Lien",pay:18,deadline:"05 juin 2026",theme:"💳 Finance",status:"completed",desc:"Questionnaire rapide sur votre satisfaction vis-à-vis des services bancaires en ligne."},
  {id:4,title:"Usage des assistants vocaux",researcher:"Martin G.",company:"VoiceLab",dur:"20 min",mode:"IA",pay:27,deadline:"15 juin 2026",theme:"🤖 Tech",status:"available",desc:"Parlez-nous de votre usage quotidien des assistants vocaux (Alexa, Siri, Google Assistant…)."},
];
const INIT_MESSAGES=[
  {id:1,from:"Sophie R.",role:"researcher",avatar:"SR",time:"Hier 14:22",study:"Test UX application mobile",messages:[{from:"Sophie R.",text:"Bonjour ! Merci pour votre participation. Avez-vous pu accéder au lien de l'étude sans problème ?",time:"14:22",mine:false},{from:"Vous",text:"Oui, tout s'est bien passé ! J'ai complété le formulaire en environ 18 minutes.",time:"14:35",mine:true},{from:"Sophie R.",text:"Parfait, merci beaucoup ! Votre paiement de 27€ a été envoyé sur votre PayPal. 🎉",time:"14:40",mine:false}]},
...
const INIT_NOTIFS_P=[
  {id:1,type:"pay",text:"Vous avez reçu 27€ sur votre PayPal pour « Test UX mobile »",time:"Hier",read:false},
