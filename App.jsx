...
const INIT_R_STUDIES=[
  {id:1,title:"Test UX application mobile",theme:"🎨 UX / Design produit",dur:"20 min",mode:"Lien",link:"https://forms.typeform.com/abc",target:12,joined:8,budget:240,status:"active",created:"28 mai 2026"},
  {id:2,title:"Perception marque Gen Z",theme:"📣 Marketing & Branding",dur:"10 min",mode:"IA",link:"",target:20,joined:20,budget:600,status:"completed",created:"12 mai 2026"},
  {id:3,title:"Habitudes bancaires 2026",theme:"💳 Finance & Banque",dur:"45 min",mode:"Lien",link:"https://typeform.com/xyz",target:10,joined:3,budget:120,status:"active",created:"01 juin 2026"},
];
const INIT_P_STUDIES=[
  {id:1,title:"Test UX application mobile",researcher:"Sophie R.",company:"DesignLab",dur:"20 min",mode:"Lien",pay:30,deadline:"08 juin 2026",theme:"🎨 UX",status:"available",desc:"Nous testons une nouvelle application mobile de gestion de tâches. Vous naviguerez dans des maquettes interactives et donnerez votre avis."},
  {id:2,title:"Habitudes alimentaires 2026",researcher:"Lucas P.",company:"FoodInsights",dur:"45 min",mode:"IA",pay:40,deadline:"12 juin 2026",theme:"🛒 Conso",status:"available",desc:"Une étude sur vos habitudes alimentaires quotidiennes. Entretien mené par IA, réponses libres."},
  {id:3,title:"Satisfaction service bancaire",researcher:"Amira K.",company:"BNP Paribas",dur:"10 min",mode:"Lien",pay:20,deadline:"05 juin 2026",theme:"💳 Finance",status:"completed",desc:"Questionnaire rapide sur votre satisfaction vis-à-vis des services bancaires en ligne."},
  {id:4,title:"Usage des assistants vocaux",researcher:"Martin G.",company:"VoiceLab",dur:"20 min",mode:"IA",pay:30,deadline:"15 juin 2026",theme:"🤖 Tech",status:"available",desc:"Parlez-nous de votre usage quotidien des assistants vocaux (Alexa, Siri, Google Assistant…)."},
];
const INIT_MESSAGES=[
  {id:1,from:"Sophie R.",role:"researcher",avatar:"SR",time:"Hier 14:22",study:"Test UX application mobile",messages:[{from:"Sophie R.",text:"Bonjour ! Merci pour votre participation. Avez-vous pu accéder au lien de l'étude sans problème ?",time:"14:22",mine:false},{from:"Vous",text:"Oui, tout s'est bien passé ! J'ai complété le formulaire en environ 18 minutes.",time:"14:35",mine:true},{from:"Sophie R.",text:"Parfait, merci beaucoup ! Votre paiement de 30€ a été envoyé sur votre PayPal. 🎉",time:"14:40",mine:false}]},
  {id:2,from:"Lucas P.",role:"researcher",avatar:"LP",time:"Lundi",study:"Habitudes alimentaires 2026",messages:[{from:"Lucas P.",text:"Bonjour, je vous contacte au sujet de l'étude sur les habitudes alimentaires. Êtes-vous disponible cette semaine ?",time:"09:10",mine:false}]},
];
const INIT_NOTIFS_R=[
  {id:1,type:"join",text:"3 nouveaux participants ont rejoint votre étude « Test UX mobile »",time:"Il y a 2h",read:false},
  {id:2,type:"complete",text:"L'étude « Perception marque Gen Z » est terminée (20/20 participants)",time:"Il y a 1 jour",read:false},
  {id:3,type:"wallet",text:"Recharge de 200€ confirmée sur votre portefeuille",time:"Il y a 3 jours",read:true},
];
const INIT_NOTIFS_P=[
  {id:1,type:"pay",text:"Vous avez reçu 30€ sur votre PayPal pour « Test UX mobile »",time:"Hier",read:false},
  {id:2,type:"new",text:"2 nouvelles études correspondent à votre profil",time:"Il y a 2h",read:false},
  {id:3,type:"msg",text:"Sophie R. vous a envoyé un message",time:"Hier 14:22",read:true},
];
const ADMIN_STATS={users:2847,researchers:312,participants:2535,studies:1204,revenue:48620,pending:18};
    ...
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column"}}>
      ...
      <header style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"18px 56px",borderBottom:`1px solid ${C.border}`,position:"sticky",top:0,background:C.bg+"ee",backdropFilter:"blur(12px)",zIndex:50}}>
        ...
        <nav style={{display:"flex",gap:28,alignItems:"center"}}>
          {["Comment ça marche","Tarifs","FAQ"].map(l=>(<a key={l} href="#" style={{color:C.muted,textDecoration:"none",fontSize:14}}>{l}</a>))}
        </nav>
      ...
      {/* How it works */}
      <section style={{padding:"60px 56px",borderTop:`1px solid ${C.border}`}}>
        <h2 style={{textAlign:"center",fontSize:32,fontWeight:900,marginBottom:8,letterSpacing:"-1px"}}>Comment ça marche ?</h2>
        <p style={{textAlign:"center",color:C.muted,marginBottom:40,fontSize:15}}>En 3 étapes simples</p>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:24,maxWidth:900,margin:"0 auto"}}>
          {[
            {n:"01",icon:"🎯",title:"Créez votre étude",desc:"Choisissez thème, durée et mode d'entretien. Définissez le profil de vos participants cibles."},
            {n:"02",icon:"👥",title:"Recrutez en 48h",desc:"Notre algorithme notifie les participants correspondant à votre profil. Vous suivez les inscriptions en temps réel."},
            {n:"03",icon:"💡",title:"Analysez & Payez",desc:"Recevez les verbatims et insights. Les participants sont payés automatiquement via PayPal."},
          ].map(s=>(
            <Card key={s.n} style={{padding:"28px 24px"}}>
              <div style={{fontSize:11,fontWeight:800,color:C.accent,letterSpacing:1,marginBottom:10}}>{s.n}</div>
              <div style={{fontSize:32,marginBottom:12}}>{s.icon}</div>
              <h3 style={{fontWeight:800,marginBottom:8,fontSize:16}}>{s.title}</h3>
      ...
      {/* Pricing */}
      <section style={{padding:"60px 56px",borderTop:`1px solid ${C.border}`}} id="tarifs">
        <h2 style={{textAlign:"center",fontSize:32,fontWeight:900,marginBottom:8,letterSpacing:"-1px"}}>Tarifs transparents</h2>
        <p style={{textAlign:"center",color:C.muted,marginBottom:40,fontSize:15}}>Par participant recruté, sans abonnement</p>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:20,maxWidth:800,margin:"0 auto"}}>
          {DURATIONS.map(d=>(
            <Card key={d.id} style={{padding:"28px 24px",textAlign:"center",border:d.popular?`1.5px solid ${C.accent}`:undefined,position:"relative"}}>
              {d.popular&&<div style={{position:"absolute",top:-12,left:"50%",transform:"translateX(-50%)",background:C.accent,color:"#fff",fontSize:11,fontWeight:700,padding:"3px 12px",borderRadius:20}}>Populaire</div>}
              <div style={{fontSize:40,fontWeight:900,color:C.accentLight,letterSpacing:"-1px"}}>{d.price}€</div>
              <div style={{fontSize:13,color:C.muted,marginBottom:12}}>par participant</div>
              <div style={{fontWeight:800,fontSize:18,marginBottom:8}}>{d.l}</div>
              <div style={{fontSize:13,color:C.muted,marginBottom:16}}>{d.desc}</div>
              <div style={{fontSize:12,color:C.muted,borderTop:`1px solid ${C.border}`,paddingTop:12}}>+ 10€ option entretiens IA</div>
            </Card>
          ))}
        </div>
        <p style={{textAlign:"center",color:C.muted,fontSize:13,marginTop:24}}>Rechargez votre portefeuille à l'avance · Aucun abonnement · Sans engagement</p>
      </section>
      ...
      <section style={{padding:"60px 56px",borderTop:`1px solid ${C.border}`,background:C.surface}}>
        <div style={{maxWidth:900,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:48,alignItems:"center"}}>
          <div>
            ...
            <p style={{color:C.muted,lineHeight:1.7,marginBottom:24}}>Rejoignez des milliers de participants qui donnent leur avis sur des produits et services réels. Chaque participation est rémunérée directement sur votre PayPal.</p>
            <ul style={{listStyle:"none",display:"flex",flexDirection:"column",gap:10,marginBottom:28}}>
              {["20€ à 40€ par entretien","Paiement PayPal sous 48h","Études de 10 à 45 minutes","100% en ligne, à votre rythme"].map(i=>(
          ...
          <div style={{display:"flex",flexDirection:"column",gap:12}}>
            {[{icon:"🎨",title:"Test UX app mobile",pay:"30€",dur:"20 min"},{icon:"🛒",title:"Habitudes alimentaires",pay:"40€",dur:"45 min"},{icon:"🤖",title:"Usage assistants vocaux",pay:"30€",dur:"20 min"}].map(s=>(
              <Card key={s.title} style={{padding:"16px 18px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <div style={{display:"flex",gap:12,alignItems:"center"}}>
                  <span style={{fontSize:22}}>{s.icon}</span>
                  <div><div style={{fontWeight:700,fontSize:14}}>{s.title}</div><div style={{fontSize:12,color:C.muted}}>⏱ {s.dur}</div></div>
                </div>
                <span style={{fontWeight:900,color:C.green,fontSize:18}}>{s.pay}</span>
              </Card>
            ))}
          </div>
        </div>
      ...
      {/* FAQ */}
      <section style={{padding:"60px 56px",borderTop:`1px solid ${C.border}`}} id="faq">
        <h2 style={{textAlign:"center",fontSize:32,fontWeight:900,marginBottom:8,letterSpacing:"-1px"}}>Questions fréquentes</h2>
        <p style={{textAlign:"center",color:C.muted,marginBottom:36,fontSize:15}}>Tout ce que vous devez savoir</p>
        <div style={{maxWidth:680,margin:"0 auto",display:"flex",flexDirection:"column",gap:8}}>
          {faqs.map((f,i)=>(
            <Card key={i} style={{overflow:"hidden"}}>
              <button onClick={()=>setFaq(faq===i?null:i)} style={{width:"100%",background:"none",border:"none",color:C.text,padding:"16px 20px",textAlign:"left",display:"flex",justifyContent:"space-between",alignItems:"center",cursor:"pointer",fontSize:14,fontWeight:700}}>
                {f.q}<span style={{color:C.muted,transition:"transform .2s",transform:faq===i?"rotate(180deg)":"none"}}>▾</span>
              </button>
              {faq===i&&<div style={{padding:"0 20px 16px",fontSize:14,color:C.muted,lineHeight:1.7}}>{f.a}</div>}
            </Card>
          ))}
        </div>
      </section>
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
        <Card style={{width:"100%",maxWidth:460,padding:"36px 36px"}}>
          ...
          {!isLogin&&isPart&&(<>
            ...
            <Inp label="Adresse PayPal *" type="email" placeholder="paypal@exemple.com" value={f.paypal} onChange={e=>setF({...f,paypal:e.target.value})} hint="💸 Vos revenus seront virés automatiquement sur ce compte PayPal."/>
          </>)}
          {!isLogin&&(
          ...
          <Btn full style={{background:accent}} onClick={submit}>{isLogin?"Se connecter →":"Créer mon compte →"}</Btn>
...
function ResearcherDashboard({onLogout}){
  ...
  const [wallet,setWallet]=useState(185);
  const [notifs,setNotifs]=useState(INIT_NOTIFS_R);
  const [msgs,setMsgs]=useState([
    {id:1,from:"Marie L.",avatar:"ML",time:"Il y a 2h",study:"Test UX app mobile",unread:1,messages:[{from:"Marie L.",text:"Bonjour, j'ai bien complété le formulaire. Tout s'est bien passé !",time:"14:22",mine:false}]},
    {id:2,from:"Paul D.",avatar:"PD",time:"Hier",study:"Habitudes bancaires",unread:0,messages:[{from:"Paul D.",text:"Merci pour l'invitation à cette étude.",time:"09:10",mine:false},{from:"Vous",text:"Merci pour votre participation Paul !",time:"09:25",mine:true}]},
  ]);
  ...
  const [invoices]=useState([{id:"INV-001",date:"01 juin 2026",amount:"240€",study:"Test UX mobile",status:"Payée"},{id:"INV-002",date:"15 mai 2026",amount:"600€",study:"Perception marque Gen Z",status:"Payée"}]);
  ...
  const publishStudy=()=>{
    ...
    setStudies(prev=>[...prev,{id:Date.now(),title:ns.title||"Nouvelle étude",theme:`${t?.i} ${t?.l}`,dur:d?.l,mode:ns.ai?"IA":"Lien",link:ns.link,target:10,joined:0,budget:0,status:"active",created:new Date().toLocaleDateString("fr-FR",{day:"2-digit",month:"short",year:"numeric"})}]);
    setWallet(prev=>prev-studyCost);
    setShowStudyModal(false);setNsStep(0);setNs({title:"",theme:"",dur:"",mode:"",link:"",ai:false,description:""});
  };
  const doRecharge=()=>{const a=parseFloat(recharge.amt);if(a>0){setWallet(prev=>prev+a);setRecharge(r=>({...r,done:true}));}};
    ...
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",fontFamily:FONT}}>
      ...
      <header style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"12px 28px",borderBottom:`1px solid ${C.border}`,background:C.surface,position:"sticky",top:0,zIndex:40}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:14}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            <Avatar initials="SR" color={C.accent}/>
            <div style={{fontSize:13}}><div style={{fontWeight:700}}>Sophie Ramos</div><div style={{color:C.muted,fontSize:11}}>Chercheur</div></div>
          </div>
      ...
      <div style={{display:"flex",flex:1}}>
        ...
        <main style={{flex:1,padding:"28px 32px",overflowY:"auto",background:C.bg}}>
          ...
          {tab==="overview"&&(
            <div>
              <h1 style={{fontSize:22,fontWeight:800,marginBottom:4}}>Bonjour, Sophie 👋</h1>
          ...
          {tab==="wallet"&&(
            <div style={{maxWidth:600}}>
              ...
              <Card style={{overflow:"hidden"}}>
                {[
                  {l:"Recharge carte",d:"02 juin 2026",a:"+200.00€",c:C.green},
                  {l:"Étude : Test UX mobile (8×30€)",d:"31 mai 2026",a:"-240.00€",c:C.red},
                  {l:"Recharge carte",d:"15 mai 2026",a:"+500.00€",c:C.green},
                  {l:"Étude : Perception marque Gen Z (20×30€)",d:"10 mai 2026",a:"-600.00€",c:C.red},
                  {l:"Bonus bienvenue",d:"01 mai 2026",a:"+25.00€",c:C.green},
                ].map((t,i)=>(
          ...
          {tab==="settings"&&(
            <div style={{maxWidth:560}}>
              ...
              <Card style={{padding:24,marginBottom:16}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}><Inp label="Prénom" defaultValue="Sophie"/><Inp label="Nom" defaultValue="Ramos"/></div>
                <Inp label="E-mail" type="email" defaultValue="sophie@designlab.com"/>
                <Inp label="Entreprise" defaultValue="DesignLab Studio"/>
                <Inp label="Téléphone" defaultValue="+33 6 12 34 56 78"/>
                <Btn>Enregistrer</Btn>
              </Card>
              <Card style={{padding:24,marginBottom:16}}>
        ...
        <Modal onClose={()=>setShowStudyModal(false)} title={`Nouvelle étude — Étape ${nsStep+1}/4`} wide>
          ...
          {nsStep===3&&(
            <div>
              ...
              <div style={{background:C.accentGlow,border:`1px solid ${C.accent}44`,borderRadius:12,padding:"14px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <span>Coût par participant</span><strong style={{color:C.accentLight,fontSize:20}}>{studyCost}€</strong>
              </div>
        ...
        <Modal onClose={()=>setShowWalletModal(false)} title={recharge.done?"":"Recharger le portefeuille"}>
          {!recharge.done?(
            <>
              ...
              <Divider/>
              <p style={{fontWeight:700,fontSize:14,marginBottom:12}}>Informations de paiement</p>
              <Inp label="Nom sur la carte" placeholder="Marie Dupont"/>
              <Inp label="Numéro de carte" placeholder="4242 4242 4242 4242"/>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}><Inp label="Expiration" placeholder="MM/AA"/><Inp label="CVV" placeholder="123"/></div>
              <Btn full onClick={doRecharge} disabled={!recharge.amt||parseFloat(recharge.amt)<=0} style={{marginTop:4}}>Payer {recharge.amt?recharge.amt+"€":""} →</Btn>
              <p style={{fontSize:11,color:C.muted,marginTop:8,textAlign:"center"}}>🔒 Paiement sécurisé · Données chiffrées SSL</p>
            </>
          ):(
...
function ParticipantDashboard({onLogout}){
  ...
  const [profile,setProfile]=useState({first:"Marie",last:"Lebrun",email:"marie.l@gmail.com",paypal:"marie.l@gmail.com",prof:"Designer freelance",bio:"Designer UX avec 5 ans d'expérience, passionnée par l'innovation produit.",age:"28-35",region:"Île-de-France"});

  const unread=notifs.filter(n=>!n.read).length;
  const unreadMsg=msgs.reduce((a,m)=>a+m.messages.filter(x=>!x.mine).length,0);
  const totalEarned=studies.filter(s=>s.status==="completed").reduce((a,s)=>a+s.pay,0)+90;
    ...
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",fontFamily:FONT}}>
      <header style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"12px 28px",borderBottom:`1px solid ${C.border}`,background:C.surface,position:"sticky",top:0,zIndex:40}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:14}}>
          ...
          <Avatar initials="ML" color={C.green}/>
          <Btn secondary small onClick={onLogout}>Déconnexion</Btn>
        </div>
        {showNotifs&&(
          <div style={{position:"absolute",top:64,right:28,width:340,background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,boxShadow:"0 16px 48px rgba(0,0,0,.5)",zIndex:100}}>
      ...
      <div style={{display:"flex",flex:1}}>
        ...
        <main style={{flex:1,padding:"28px 32px",overflowY:"auto",background:C.bg}}>
          ...
          {tab==="overview"&&(
            <div>
              <h1 style={{fontSize:22,fontWeight:800,marginBottom:4}}>Bonjour, Marie 👋</h1>
          ...
          {tab==="earnings"&&(
            <div style={{maxWidth:580}}>
              ...
              <Card style={{overflow:"hidden"}}>
                {[
                  {l:"Test UX application mobile",d:"03 juin 2026",a:"+30.00€",s:"Virée"},
                  {l:"Satisfaction service bancaire",d:"28 mai 2026",a:"+20.00€",s:"Virée"},
                  {l:"Habitudes numériques",d:"15 mai 2026",a:"+40.00€",s:"Virée"},
                  {l:"Test interface e-commerce",d:"02 mai 2026",a:"+30.00€",s:"Virée"},
                ].map((t,i)=>(
                  <div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 20px",borderBottom:`1px solid ${C.border}`}}>
                    <div><div style={{fontSize:14,fontWeight:600}}>{t.l}</div><div style={{fontSize:12,color:C.muted}}>{t.d}</div></div>
                    <div style={{display:"flex",gap:10,alignItems:"center"}}>
            ...
            <div style={{maxWidth:560}}>
              ...
              <Card style={{padding:24,marginBottom:16}}>
                <div style={{display:"flex",gap:16,alignItems:"center",marginBottom:20}}>
                  <Avatar initials="ML" color={C.green} size={52}/>
        ...
        <Modal onClose={()=>setShowWithdraw(false)} title={withdrawDone?"":"Retirer mes gains"}>
          {!withdrawDone?(
            <>
              ...
              <Btn full green onClick={()=>setWithdrawDone(true)}>Confirmer le retrait → PayPal</Btn>
...
function AdminPanel({onLogout}){
  ...
  const [users]=useState([
    {id:1,name:"Sophie Ramos",email:"sophie@designlab.com",role:"Researcher",joined:"01 mai 2026",studies:3,status:"active"},
    {id:2,name:"Marie Lebrun",email:"marie.l@gmail.com",role:"Participant",joined:"15 avril 2026",earnings:"90€",status:"active"},
          ...
          {tab==="transactions"&&(
            <div>
              ...
              <Card style={{overflow:"hidden"}}>
                ...
                {[
                  {d:"Recharge portefeuille",u:"Sophie Ramos",date:"02 juin 2026",a:"+200€",c:C.green},
                  {d:"Paiement participant",u:"Marie Lebrun",date:"03 juin 2026",a:"-30€",c:C.red},
