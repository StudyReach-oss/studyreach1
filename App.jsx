...
async function notifyResearcherPendingValidation({researcherId,studyTitle,participantName,token}){
  ...
  try{
    ...
    if(!r?.email)return;
    const deadlineISO=new Date(Date.now()+7*24*3600*1000).toISOString();
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//  DÉLAI DE VALIDATION (7 jours après pending_validation)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// "urgent" : ≤24h restantes · "warning" : ≤48h restantes · null sinon.
                            ...
                            <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
                              ...
                              <div style={{flex:1,minWidth:140}}>
                                <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap",marginBottom:5}}>
                                  ...
                                  {isPending&&<DeadlineBadge deadline={t.validationDeadline}/>}
                                </div>
      ...
      try{
        ...
        setStudies(prev=>{
          ...
          const updated=prev.map(s=>{
            ...
            return found?{...s,status:found.status,participationId:found.participationId,paid:found.paid,autoValidated:found.autoValidated}:s;
          });
