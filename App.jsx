  ...
  const callAi=async(history)=>{
    ...
    try{
      const res=await fetch("/api/ai-interview",{
        ...
        body:JSON.stringify({
          action:"chat",
          study:{title:study.title,theme:study.theme,description:study.description,ai_focus:study.ai_focus,dur:study.dur},
          messages:history
        })
      });
      const data=await res.json();
  ...
  const finishInterview=async()=>{
    ...
    try{
      const res=await fetch("/api/ai-interview",{
        ...
        body:JSON.stringify({
          action:"report",
          study:{title:study.title,theme:study.theme,description:study.description,ai_focus:study.ai_focus},
          messages
        })
      });
      const data=await res.json();
      onComplete(study,messages,data.report||"Rapport indisponible.",videoUrls);
    }catch(e){
