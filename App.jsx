                                  ...
                                  <div style={{minWidth:0}}>
                                    <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
                                      ...
                                      {(()=>{const st=payoutState(t);const m=PAYOUT_META[st];
                                        ...
                                        return <><span style={{fontSize:10,fontWeight:800,padding:"1px 8px",borderRadius:10,display:"inline-flex",alignItems:"center",gap:4,background:m.color+"22",color:m.color,border:`1px solid ${m.color}44`}}>{ic} {m.label}</span><span style={{fontSize:10,color:C.muted}}>— {exp}</span></>;
                                      })()}
                                    </div>
                                    {t.aiInterview?.report&&(
                                      <div style={{marginTop:6}}>
