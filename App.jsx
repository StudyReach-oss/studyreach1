    ...
    <Modal onClose={onClose} title={`🤖 StudyReach AI — ${study.title}`} wide>
      ...
      {finished?(
        ...
        <div>
          ...
          {turnsDone>=maxTurnsTotal-1&&(
          <div style={{display:"flex",justifyContent:"flex-end",marginTop:8}}>
            <button onClick={finishEarly} disabled={loading||finishing} title="Terminer l'entretien maintenant et envoyer vos réponses au chercheur" style={{background:"transparent",border:`1px solid ${C.border}`,borderRadius:8,color:C.muted,fontSize:12,fontWeight:600,cursor:loading||finishing?"default":"pointer",padding:"6px 12px",opacity:loading||finishing?.5:1}}>
              🏁 Terminer l'étude
            </button>
          </div>
          )}
