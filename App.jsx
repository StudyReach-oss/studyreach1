    ...
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column"}}>
      ...
      <section style={{textAlign:"center",padding:"80px 24px 60px",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{display:"flex",gap:40,justifyContent:"center",marginTop:52,flexWrap:"wrap"}}>
          {[["20–40€","par entretien"],["48h","délai de versement"],["100%","en ligne"],["IA","entretiens automatisés"]].map(([v,l])=>(
      ...
      <section className="landing-section-pad" style={{padding:"60px 56px",borderTop:`1px solid ${C.border}`}}>
        <div style={{maxWidth:1040,margin:"0 auto"}}>
          ...
          <div className="landing-section-grid" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
            {[
              ["🤖","Entretiens IA","Notre IA mène l'entretien à votre place selon votre guide : elle relance, s'adapte, et vous livre un rapport avec les verbatims complets."],
              ["🎯","Recrutement ciblé","Critères de profil et ciblage géographique : seuls les participants pertinents sont notifiés de votre étude."],
              ...
              ["⚡","Matching automatique","Un algorithme met votre étude en avant auprès des bons profils. Vos premiers participants sous 48h."],
              ["💳","Paiements sécurisés","Portefeuille rechargeable, versements Stripe, validation manuelle et export CSV/PDF de vos résultats."],
            ].map(([ic,t,d])=>(
  ...
  const pages={
    ...
    "faq":{
      ...
      sections:[
        ...
        {icon:"✉️",title:"Je n’ai pas trouvé ma réponse, que faire ?",body:"Contactez-nous directement à contact@getstudyreach.com. Nous répondons généralement sous 24h ouvrables."},
      ]
    },
  };
