          ...
          {tab==="wallet"&&(
            <div style={{maxWidth:800}}>
              ...
              <div style={{display:"flex",gap:14,flexWrap:"wrap",marginBottom:12,fontSize:11,color:C.muted}}>
                ...
                <span style={{display:"flex",alignItems:"center",gap:5}}><span style={{color:C.white,fontSize:14,fontWeight:900}}>✕</span> <b style={{color:C.text}}>Expiré</b> — a quitté la session sans terminer l'enquête (24h)</span>
              </div>
